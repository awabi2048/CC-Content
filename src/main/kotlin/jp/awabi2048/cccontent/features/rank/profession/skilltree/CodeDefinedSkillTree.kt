...
private object ProfessionSkillTreeDefinitions {
    ...
    fun get(profession: Profession): CodeDefinedSkillTree.Definition = when (profession) {
        Profession.BREWER -> definition(
            ...
            node(profession, "skill5", 20, "FERMENTED_SPIDER_EYE", listOf("skill7", "skill9")),
            node(profession, "skill6", 25, "CLOCK", listOf("skill8")),
            node(profession, "skill7", 30, "CAULDRON", listOf("skill10")),
            node(profession, "skill8", 35, "GLOWSTONE_DUST", listOf("skill11")),
            node(profession, "skill9", 30, "GUNPOWDER", listOf("skill10")),
            node(profession, "skill10", 35, "DRAGON_BREATH", listOf("skill11")),
        ...
        Profession.COOK -> definition(
            ...
            node(profession, "skill3", 4, "COOKED_BEEF", listOf("skill8")),
            ...
            node(profession, "skill5", 4, "RABBIT_STEW", listOf("skill8")),
