...
class ResourceCollectionItems(plugin: JavaPlugin) {
    ...
    private val definitions = listOf(
        ...
        Definition("mugwort", Material.FERN, setOf("plant", "herb", "spring")),
        Definition("mint", Material.MANGROVE_LEAVES, setOf("plant", "herb", "summer")),
        Definition("porcini", Material.BROWN_MUSHROOM, setOf("plant", "fungus", "autumn")),
        Definition("rosehip", Material.SWEET_BERRIES, setOf("plant", "fruit", "winter")),
