...
class MagicConcaveLensItem : CustomItem {
    override val feature: String = "misc"
    override val id: String = "magic_concave_lens"
    override val displayName: String = "§b魔力が籠った凹レンズ"
    override val lore: List<String> = listOf(
        "§7巨大化ゴーレムに埋め込まれたコアを加工して作られたレンズ",
        "§6懐中電灯みたいなもの§7に組み込めるかも"
    )
    override val itemModel: NamespacedKey = NamespacedKey.minecraft("glass_pane")

    private val itemKey = NamespacedKey("cccontent", "magic_concave_lens")
