...
class TaroSnackItem : CustomItem {
    override val feature: String = "misc"
    override val id: String = "taro_snack"
    override val displayName: String = "§bたろうのおやつ"
    override val lore: List<String> = listOf(
        "§7たろうのおやつになる予定だった骨",
        "§7形がちょうど良いのだとか"
    )
    override val itemModel: NamespacedKey = NamespacedKey.minecraft("bone")

    private val itemKey = NamespacedKey("cccontent", "taro_snack")
