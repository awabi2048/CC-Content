...
class DenseWindChargeItem : CustomItem {
    override val feature: String = "misc"
    override val id: String = "dense_wind_charge"
    override val displayName: String = "§e高密度ウィンドチャージ"
    override val lore: List<String> = listOf(
        "§7高密度に圧縮されたウィンドチャージ",
        "§6風を起こす道具§7に使えるかも"
    )
    override val itemModel: NamespacedKey = NamespacedKey.minecraft("snowball")

    private val itemKey = NamespacedKey("cccontent", "dense_wind_charge")
